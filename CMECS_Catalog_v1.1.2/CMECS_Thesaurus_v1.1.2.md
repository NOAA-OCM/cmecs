...
# Introduction
This document presents the terms and definitions for the Coastal and Marine Ecological Classification Standard (CMECS) Catalog, Version 1.1.2, organized hierarchically. This update primarily addresses typo corrections; full details can be found in the [version 1.1.2 Release Notes](https://github.com/NOAA-OCM/cmecs/releases/tag/untagged-e702e43b8347f82ba2b4). 

All other settings, components, modifiers, and units are identical to the previous version of the CMECS Thesaurus (Version 1.1.0). Unless specified otherwise, all cross-references to page numbers, sections, figures, and tables in this catalog refer back to the original CMECS FGDC-STD-018-2012 document.
</details>
