# About CMECS Catalog v1.1.2 files

The files in this directory contain the CMECS Catalog v1.1.2 in various formats.
...
- [CMECS_1.1.1_UnitCode_Crosswalk.xlsx](https://github.com/NOAA-OCM/cmecs/blob/main/CMECS_Catalog_v1.1.2/CMECS_1.1.1_UnitCode_Crosswalk.xlsx) _** **UNCHANGED** **_
#### Side-by-side Comparison Tables of the changes to the Substrate Component adopted in v1.1.0 _** **UNCHANGED** **_
- [SC_Comparison_Tables_v1.0.0-v1.1.0.xlsx](https://github.com/NOAA-OCM/cmecs/blob/main/CMECS_Catalog_v1.1.2/SC_Comparison_Tables_v1.0.0-v1.1.0.xlsx) _** **UNCHANGED** **_
...
- Geoform Component: [CMECS_Catalog_v1.1.2-GC.csv](CMECS_Catalog_v1.1.2-GC.csv) _** **UNCHANGED** **_
- Substrate Component: [CMECS_Catalog_v1.1.2-SC.csv](CMECS_Catalog_v1.1.2-SC.csv) _** **UNCHANGED** **_
- Water Column Component: [CMECS_Catalog_v1.1.2-WC.csv](CMECS_Catalog_v1.1.2-WC.csv) _** **UNCHANGED** **_
